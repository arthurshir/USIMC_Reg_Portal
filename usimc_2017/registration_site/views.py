...
#        print("Request\nFILES: {}\n POST: {}".format(request.FILES, request.POST))
        ...
        entry.teacher.phone_number = _cf(self.context['teacher_form']['phone_number'].value())
    ...
    def blank_validation_messages(self, request):
        ...
        birth_image_none_or_temp_value = "not_empty" if bool(entry.lead_performer.birth_certificate_image) else None
        add_blank_error('lead_competitor_form', 'birth_certificate_image', birth_image_none_or_temp_value) # reason for bool() -> https://stackoverflow.com/questions/5213025/how-to-check-imagefield-is-empty
